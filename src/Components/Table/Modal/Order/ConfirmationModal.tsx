...
export default function ConfirmationModal({
  ...
  return isSuccess && id_orders.length > 0 ? (
    <ModalWrapper
      title={"Confirmation"}
      showModal={showModal}
    ...
    >
      ...
      <div className="order-id-date">
        ...
        <div>
          Date:{" "}
          {new Date(currentOrder.order[0].date).toISOString().split("T")[0]}
        </div>
      </div>
      <EditProductSection
        refetch={refetch}
    ...
    <div className="card-body">
      <div className="basic-form">
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="restant-txt">
            restant: {id_orders.length - (index + 1)}
          </div>
          <div className="row">
            <CustumSelectForm
          ...
          {isLoading ? (
            ...
            <>
              ...
              <a
                href="#"
                onClick={onNext}
                className="btn light btn-light next-btn"
              >
                Suivant
              </a>
            </>
...
const EditProductSection = ({
  ...
  refetch,
  id,
}: EditProductSectionProps): JSX.Element => {
  ...
  return (
    <div className="mb-3 col-md-4 lg-input-cus">
      ...
      >
        ...
        {data.map((dt) => (
          <option selected={statusConfirmation === dt.value} value={dt.value}>
            {dt.label}
          </option>
        ))}
      </select>
