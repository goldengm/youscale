...
export default function Paiement() {
    ...
    return (
        <Main name='Paiement'>
            {showAddPerteModal && <AddPerteModal setShowModal={setShowAddPerteModal} showModal={showAddPerteModal} />}
            <div className="content-body">
                <div className="container-fluid">
                    <DisplayCard />
                    <div className="row"><Goal /></div>
                    <div className="row">
                        <Transaction setShowAddPerteModal={setShowAddPerteModal} />
                        <DetailsOfSpending />
                    </div>
                </div>
            </div>
...
const Transaction = ({setShowAddPerteModal}:TransactionProps): JSX.Element => {
    return (
...
const TransactionRow = (): JSX.Element => {
    return (
        <li>
            <div className="timeline-panel">
                <div className="media-body">
                    <h5 className="mb-1">Tiktok ads - <strong>Iphone14</strong></h5>
                    <small className="d-block">2023-03-30 - 2023-03-31</small>
                </div>
