...
const convertTeamMember = (
  ...
  let out: dataType[] = [{ label: "Aucun", value: String(0) }];
  //var out: dataType[] = [];
    ...
    <div style={{ marginTop: "100px" }}>
      ...
      <div className="nav-header">
        ...
        <div
          ...
          className="nav-control d-block d-sm-none"
        >
                ...
                <ul className="navbar-nav header-right">
                  ...
                  <li className="nav-item" id="nav5">
                    ...
                    >
                      ...
                      >
                        <path
                          d="M18 2.25C9.30234 2.25 2.25 9.30234 2.25 18C2.25 26.6977 9.30234 33.75 18 33.75C26.6977 33.75 33.75 26.6977 33.75 18C33.75 9.30234 26.6977 2.25 18 2.25ZM23.066 18.2426L15.3879 23.8289C15.3458 23.8592 15.2962 23.8772 15.2445 23.8811C15.1928 23.885 15.141 23.8745 15.0949 23.8509C15.0488 23.8273 15.01 23.7914 14.9829 23.7472C14.9559 23.703 14.9415 23.6522 14.9414 23.6004V12.4348C14.9412 12.3828 14.9555 12.3319 14.9825 12.2875C15.0095 12.2431 15.0483 12.2071 15.0945 12.1835C15.1407 12.1598 15.1926 12.1494 15.2444 12.1534C15.2962 12.1575 15.3459 12.1757 15.3879 12.2063L23.066 17.7891C23.1023 17.8147 23.1319 17.8487 23.1523 17.8882C23.1727 17.9276 23.1834 17.9714 23.1834 18.0158C23.1834 18.0602 23.1727 18.104 23.1523 18.1435C23.1319 18.1829 23.1023 18.2169 23.066 18.2426Z"
                          fill="#111111"
                          fill-opacity="0.85"
                        />
                      </svg>
