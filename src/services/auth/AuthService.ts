...
import { CLIENT_LOGIN_URL, CLIENT_REGISTER_URL, ADMIN_LOGIN_URL, ADMIN_REGISTER_URL, ADMIN_TEAM_LOGIN_URL, CLIENT_TEAM_LOGIN_URL, CLIENT_OTP_URL } from "../url/API_URL";
